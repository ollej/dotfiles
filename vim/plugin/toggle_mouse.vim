...
" The default mapping is registered under to <C-F12> by default, unless the user
...
if !exists("no_plugin_maps") && !exists("no_toggle_mouse_maps")
    if !hasmapto('<SID>ToggleMouse()')
        noremap <C-F12> :call <SID>ToggleMouse()<CR>
        inoremap <C-F12> <Esc>:call <SID>ToggleMouse()<CR>a
    endif
endif
